...
RSGCore.Functions.CreateUseableItem('pickaxe', function(source, item)
    local src = source
    print('Triggered')
...
RegisterNetEvent('jc-mining:server:giveFlakes', function(amount)
    ...
    Player.Functions.AddItem('goldflakes', amount)
    TriggerClientEvent('inventory:client:ItemBox', src, RSGCore.Shared.Items['goldflakes'], 'add')
end)
